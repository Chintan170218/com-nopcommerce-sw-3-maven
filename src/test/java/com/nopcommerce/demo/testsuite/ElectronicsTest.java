...
public class ElectronicsTest extends TestBase {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.enterLastName("abc123");
        registerPage.enterDayField("11");
        registerPage.enterMonthField("September");
        registerPage.enterYearField("1998");
        registerPage.enterEmail("abc132@gmail.com");
        ...
        cartPage.selectTermsOfService();
        cartPage.selectCheckoutButton();
        checkoutPage.enterFirstName("David");
        checkoutPage.enterLastName("Letterman");
        checkoutPage.enterCountry("United Kingdom");
        checkoutPage.enterState("Other");
        checkoutPage.enterCity("London");
        checkoutPage.enterAddress("123 Ashgrove Rd");
        checkoutPage.enterPostcode("TW18 7HG");
        checkoutPage.enterPhoneNo("01753 593236");
        ...
        paymentInformationPage.enterCardholderName("MR D B LETTERMAN");
